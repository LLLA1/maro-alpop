...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "alpop")

OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [5964879906]
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)

UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/LLLA1/maro-alpop")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/f698f60484b7aef0d6f29.jpg")
